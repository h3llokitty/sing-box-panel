...
T[existing_install_get_b.en]="  3) get the installer script for server B (no service restart)"
T[existing_install_get_b.ru]="  3) получить установочный скрипт для сервера B (без перезапуска служб)"
...
T[prompt_choice_013_default1.en]="Choice [0-3, Enter=1]: "
T[prompt_choice_013_default1.ru]="Выбор [0-3, Enter=1]: "
T[b_generator_config_missing.en]="Cannot generate the server B installer: configuration file not found: %s"
T[b_generator_config_missing.ru]="Невозможно создать установщик сервера B: не найден файл конфигурации: %s"
T[b_generator_binary_missing.en]="Cannot generate the server B installer: managed sing-box binary not found: %s"
T[b_generator_binary_missing.ru]="Невозможно создать установщик сервера B: не найден управляемый бинарный файл sing-box: %s"
T[b_generator_params_missing.en]="Cannot generate the server B installer. Missing saved parameters: %s"
T[b_generator_params_missing.ru]="Невозможно создать установщик сервера B. Не сохранены параметры: %s"
T[new_b_intro.en]="Preparing a standalone server B. Server A configuration will not be changed."
T[new_b_intro.ru]="Подготовка автономного сервера B. Конфигурация сервера A изменена не будет."
T[b_domain_required.en]="Server B domain cannot be empty. Configure its DNS A record and run this option again."
T[b_domain_required.ru]="Домен сервера B не может быть пустым. Настройте для него DNS A-запись и повторите этот пункт."
T[b_port_invalid.en]="Server B port must be a number from 1 to 65535."
T[b_port_invalid.ru]="Порт сервера B должен быть числом от 1 до 65535."
T[b_vless_dest_required.en]="The Reality masking domain for server B cannot be empty."
T[b_vless_dest_required.ru]="Домен маскировки Reality для сервера B не может быть пустым."
T[new_b_a_unchanged.en]="This standalone B installer did not change the saved or running configuration of server A."
T[new_b_a_unchanged.ru]="Этот автономный установщик B не изменил ни сохранённый, ни работающий конфиг сервера A."
T[b_standalone_ready.en]="This server B is ready and standalone; no server A was configured to use it."
T[b_standalone_ready.ru]="Сервер B готов и работает автономно; ни один сервер A не был настроен на его использование."
T[b_delivery_config_missing.en]="Cannot publish the B binary: nginx profile configuration was not found: %s"
T[b_delivery_config_missing.ru]="Невозможно опубликовать бинарник B: не найден конфиг раздачи профилей nginx: %s"
T[b_delivery_repair_failed.en]="Could not safely add B binary delivery to nginx configuration: %s"
T[b_delivery_repair_failed.ru]="Не удалось безопасно добавить раздачу бинарника B в конфиг nginx: %s"
T[b_delivery_repaired.en]="Added B binary delivery to the existing nginx configuration. Backup: %s"
T[b_delivery_repaired.ru]="В существующий конфиг nginx добавлена раздача бинарника B. Резервная копия: %s"
...
T[b_port_hy2_label.en]="  Port:   %s (Hysteria2, UDP)"
T[b_port_hy2_label.ru]="  Порт:   %s (Hysteria2, UDP)"
